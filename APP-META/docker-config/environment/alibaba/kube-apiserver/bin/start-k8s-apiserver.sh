...
$workDir/bin/kube-apiserver \
    --enable-admission-plugins=Initializers,NamespaceLifecycle,ServiceAccount,LimitRanger,DefaultStorageClass,DefaultTolerationSeconds,ResourceQuota,PodPreset,ValidatingAdmissionWebhook,MutatingAdmissionWebhook,AliPodLifeTimeHook,PodDeletionFlowControl,AliPodInjectionPreSchedule,AliPodInjectionPostSchedule,ContainerState \
