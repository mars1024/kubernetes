...
$workDir/bin/kube-apiserver \
    --enable-admission-plugins=Initializers,NamespaceLifecycle,ServiceAccount,LimitRanger,DefaultStorageClass,DefaultTolerationSeconds,PodPreset,ResourceQuota,ValidatingAdmissionWebhook,MutatingAdmissionWebhook,AliPodLifeTimeHook,PodDeletionFlowControl,AliPodInjectionPreSchedule,NewAliPodInjectionPreSchedule,AliPodInjectionPostSchedule,ContainerState,AlipayResourceMutationBestEffort,AlipaySetDefaultHostConfig \
    ...
    --feature-gates=AllAlpha=false,CSINodeInfo=true,CSIDriverRegistry=true,SelectorIndex=true,TaintNodesByCondition=false \
