...
$workDir/bin/kube-apiserver \
    --enable-admission-plugins=Initializers,NamespaceLifecycle,ServiceAccount,LimitRanger,DefaultStorageClass,DefaultTolerationSeconds,PodPreset,ResourceQuota,ValidatingAdmissionWebhook,MutatingAdmissionWebhook,AuditDelete,AliPodLifeTimeHook,PodDeletionFlowControl,AliPodInjectionPreSchedule,NewAliPodInjectionPreSchedule,AliPodInjectionPostSchedule,ContainerState \
