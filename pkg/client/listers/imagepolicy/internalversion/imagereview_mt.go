...
func (s *imageReviewLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *imageReviewLister) Get(name string) (*imagepolicy.ImageReview, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get imagereview w/o specifying tenant")
	}
