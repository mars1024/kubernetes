...
type spread struct {
	AliMaxInstancePerHost      int  `json:"ali.MaxInstancePerHost"`
	AliMaxInstancePerPhyHost   int  `json:"ali.MaxInstancePerPhyHost"`
}
//
...
type allocSpec struct {
	AliEnableOverQuota		string `json:"ali.EnableOverQuota"`
}
...
type hostConfig struct {
	...
	//Runtime					string `json:`
	NetPriority         	map[string]string   `json:"NetPriority"`
}

type extConfig struct {
	IsHost 					string `json:"IsHost"`
	//AliAcheduleAffinity 	string `json:`
	IpLabel 				string `json:"IpLabel"`
	//AliUltronAppBackend  	string `json:`
	//ContainerAsHost   		bool `json:`
	//AliExtendComplexRule    []ExtendComplexRuleInfo `json:"ali.extendComplexRule"`
	CpuSetModeAdvConfig  	cpuSetModeAdvConfig `json:"CpuSetModeAdvConfig"`
}

type prohibit struct {
	AppConstraints		map[string]int `json:"AppConstraints,omitempty"`
}

type monopolize struct {
	AppMonopolize		string `json:"AppMonopolize"`
	CpuSetMonopolize 	string `json:"CpuSetMonopolize"`
}