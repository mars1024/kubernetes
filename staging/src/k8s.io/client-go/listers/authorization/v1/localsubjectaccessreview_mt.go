...
func (s *localSubjectAccessReviewLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
	return &localSubjectAccessReviewLister{
		indexer: s.indexer,
		tenant:  tenant,
	}
}
...
func (s *localSubjectAccessReviewLister) LocalSubjectAccessReviews(namespace string) LocalSubjectAccessReviewNamespaceLister {
	return localSubjectAccessReviewNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
