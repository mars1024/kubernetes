...
func (s *clusterTestTypeLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
...
func (s *clusterTestTypeLister) Get(name string) (*v1.ClusterTestType, error) {
	if s.tenant == nil {
		...
		debug.PrintStack()
		return nil, fmt.Errorf("cannot get clustertesttype w/o specifying tenant")
	}
