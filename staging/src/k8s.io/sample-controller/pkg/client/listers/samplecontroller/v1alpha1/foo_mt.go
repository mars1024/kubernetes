...
func (s *fooLister) ShallowCopyWithTenant(tenant multitenancy.TenantInfo) interface{} {
	return &fooLister{
		indexer: s.indexer,
		tenant:  tenant,
	}
...
func (s *fooLister) Foos(namespace string) FooNamespaceLister {
	return fooNamespaceLister{indexer: s.indexer, namespace: namespace, tenant: s.tenant}
}
