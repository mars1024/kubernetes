...
import (
	...
	"gitlab.alipay-inc.com/antcloud-aks/aks-k8s-api/pkg/controller/garbagecollector/metaonly"
	...
	gb.graphChanges.Add(&event{
		...
		obj: &metaonly.MetadataOnlyObject{
			...
			ObjectMeta: metav1.ObjectMeta{
				...
				UID:         ref.UID,
				Name:        ref.Name,
				Annotations: util.TransformTenantInfoToAnnotations(ref.Tenant),
			},
		},
	})
}
...
func (gb *GraphBuilder) processGraphChanges() bool {
	...
	tenant, err := util.TransformTenantInfoFromAnnotations(accessor.GetAnnotations())
	if err != nil {
		glog.Warningf("missing tenant info in annotation from object: %v/%v", accessor.GetNamespace(), accessor.GetName())
		return true
	}
	switch {
