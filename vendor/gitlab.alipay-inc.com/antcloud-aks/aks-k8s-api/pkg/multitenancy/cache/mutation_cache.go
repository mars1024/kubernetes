...
func NewIntegerResourceVersionMutationCache(backingCache cache.Store, indexer cache.Indexer, ttl time.Duration, includeAdds bool) MutationCache {
...
func (c *mutationCache) Mutation(obj interface{}) {
	...
	key, err := MultiTenancyKeyFuncWrapper(cache.DeletionHandlingMetaNamespaceKeyFunc)(obj)
	if err != nil {
