...
var _ = Describe("BucketBinding", func() {
	var instance BucketBinding
	var expected BucketBinding
	var client BucketBindingInterface

	BeforeEach(func() {
		instance = BucketBinding{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ClusterV1alpha1().BucketBindings()
