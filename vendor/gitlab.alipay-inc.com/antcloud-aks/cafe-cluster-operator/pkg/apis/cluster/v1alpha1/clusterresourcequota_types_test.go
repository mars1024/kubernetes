...
import (
	...
	. "gitlab.alipay-inc.com/antcloud-aks/cafe-cluster-operator/pkg/client/clientset_generated/clientset/typed/cluster/v1alpha1"
)

var _ = Describe("ClusterResourceQuota", func() {
	var instance ClusterResourceQuota
	var expected ClusterResourceQuota
	var client ClusterResourceQuotaInterface

	BeforeEach(func() {
		instance = ClusterResourceQuota{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ClusterV1alpha1().ClusterResourceQuota()
