...
type ClusterResourceQuotaInterface interface {
	Create(*v1alpha1.ClusterResourceQuota) (*v1alpha1.ClusterResourceQuota, error)
	Update(*v1alpha1.ClusterResourceQuota) (*v1alpha1.ClusterResourceQuota, error)
	UpdateStatus(*v1alpha1.ClusterResourceQuota) (*v1alpha1.ClusterResourceQuota, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ClusterResourceQuota, error)
	List(opts v1.ListOptions) (*v1alpha1.ClusterResourceQuotaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterResourceQuota, err error)
...
func newClusterResourceQuotas(c *ClusterV1alpha1Client) *clusterResourceQuotas {
...
func (c *clusterResourceQuotas) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterResourceQuota, err error) {
...
func (c *clusterResourceQuotas) List(opts v1.ListOptions) (result *v1alpha1.ClusterResourceQuotaList, err error) {
...
func (c *clusterResourceQuotas) Create(clusterResourceQuota *v1alpha1.ClusterResourceQuota) (result *v1alpha1.ClusterResourceQuota, err error) {
	result = &v1alpha1.ClusterResourceQuota{}
	err = c.client.Post().
		Resource("clusterresourcequotas").
...
func (c *clusterResourceQuotas) Update(clusterResourceQuota *v1alpha1.ClusterResourceQuota) (result *v1alpha1.ClusterResourceQuota, err error) {
	result = &v1alpha1.ClusterResourceQuota{}
	err = c.client.Put().
		Resource("clusterresourcequotas").
...
func (c *clusterResourceQuotas) UpdateStatus(clusterResourceQuota *v1alpha1.ClusterResourceQuota) (result *v1alpha1.ClusterResourceQuota, err error) {
	result = &v1alpha1.ClusterResourceQuota{}
	err = c.client.Put().
		Resource("clusterresourcequotas").
		Name(clusterResourceQuota.Name).
...
func (c *clusterResourceQuotas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterResourceQuota, err error) {
	result = &v1alpha1.ClusterResourceQuota{}
