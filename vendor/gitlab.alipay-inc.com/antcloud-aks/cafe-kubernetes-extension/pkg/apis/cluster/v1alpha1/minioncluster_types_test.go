...
import (
	...
	. "gitlab.alipay-inc.com/antcloud-aks/cafe-kubernetes-extension/pkg/client/clientset_generated/clientset/typed/cluster/v1alpha1"
)

var _ = Describe("MinionCluster", func() {
	var instance MinionCluster
	var expected MinionCluster
	var client MinionClusterInterface

	BeforeEach(func() {
		instance = MinionCluster{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ClusterV1alpha1().MinionClusters("minioncluster-test-valid")
