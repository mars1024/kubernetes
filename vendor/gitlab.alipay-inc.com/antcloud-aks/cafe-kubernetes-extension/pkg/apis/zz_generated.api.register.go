...
var appsApiGroup = builders.NewApiGroupBuilder(
	"apps.cafe.cloud.alipay.com",
	"gitlab.alipay-inc.com/antcloud-aks/cafe-kubernetes-extension/pkg/apis/apps").
	WithUnVersionedApi(apps.ApiVersion).
	WithVersionedApis(
		appsv1alpha1.ApiVersion,
	).
	WithRootScopedKinds()

func GetAppsAPIBuilder() *builders.APIGroupBuilder {
	return appsApiGroup
}

var clusterApiGroup = builders.NewApiGroupBuilder(
	"cluster.cafe.cloud.alipay.com",
	"gitlab.alipay-inc.com/antcloud-aks/cafe-kubernetes-extension/pkg/apis/cluster").
