...
import (
	...
	"gitlab.alipay-inc.com/antcloud-aks/cafe-kubernetes-extension/pkg/client/clientset_generated/clientset/scheme"
...
type AppsV1alpha1Interface interface {
	...
	CafeDeploymentsGetter
	CafeInPlaceDeploymentsGetter
	InPlaceSetsGetter
}

// AppsV1alpha1Client is used to interact with features provided by the apps.cafe.cloud.alipay.com group.
type AppsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppsV1alpha1Client) CafeDeployments(namespace string) CafeDeploymentInterface {
	return newCafeDeployments(c, namespace)
}

func (c *AppsV1alpha1Client) CafeInPlaceDeployments(namespace string) CafeInPlaceDeploymentInterface {
	return newCafeInPlaceDeployments(c, namespace)
}

func (c *AppsV1alpha1Client) InPlaceSets(namespace string) InPlaceSetInterface {
