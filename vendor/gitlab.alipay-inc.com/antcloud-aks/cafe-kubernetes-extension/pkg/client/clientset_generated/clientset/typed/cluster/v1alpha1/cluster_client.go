...
type ClusterV1alpha1Interface interface {
	...
	MinionClustersGetter
}

// ClusterV1alpha1Client is used to interact with features provided by the cluster.cafe.cloud.alipay.com group.
type ClusterV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ClusterV1alpha1Client) MinionClusters() MinionClusterInterface {
	return newMinionClusters(c)
}
