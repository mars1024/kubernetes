...
// QuotaV1Client is used to interact with features provided by the quota.sigma.alipay.com group.
type QuotaV1Client struct {
	restClient rest.Interface
}

func (c *QuotaV1Client) ClusterResourceQuotas(namespace string) ClusterResourceQuotaInterface {
	return newClusterResourceQuotas(c, namespace)
}
