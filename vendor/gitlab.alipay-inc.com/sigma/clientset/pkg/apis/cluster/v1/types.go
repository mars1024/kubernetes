...
type ClusterSpec struct {
	...
	// Cluster level Custom config for all Cluster Components
	ClusterCustomConfig map[string]string `json:"clusterCustomConfig"`
}
...
const (
	ClusterTypeKOK ClusterType = "kok"
...
type ETCDConfig struct {
	...
	// 外部etcd连接需要的相关证书，保存到secret
	ClientSecret string `json:"clientSecret"`

	DisableImageUpgrade *bool `json:"disableImageUpgrade,omitempty"`
}
