...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	...
	if in.ClusterCustomConfig != nil {
		in, out := &in.ClusterCustomConfig, &out.ClusterCustomConfig
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *ETCDConfig) DeepCopyInto(out *ETCDConfig) {
	*out = *in
	...
	if in.DisableImageUpgrade != nil {
		in, out := &in.DisableImageUpgrade, &out.DisableImageUpgrade
		*out = new(bool)
		**out = **in
	}
	return
